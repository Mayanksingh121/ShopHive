const CustomerReviewCard = ({ review }) => {
  return (
    <div className="hover:bg-gradient-to-br hover:from-red-200 hover:via-purple-200 hover:to-yellow-200 border p-5 shadow-lg  md:hover:translate-y-2 transition ease-in-out rounded-lg">
